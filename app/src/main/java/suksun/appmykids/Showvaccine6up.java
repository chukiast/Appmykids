...
public class Showvaccine6up extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_showvaccine6up);
    ...
    public class SynJSON extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... voids) {
            try {
                String strURL = "http://10.0.2.2/webmykids/php_get_reportvac6.php";
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                final String[] dT = new String[jsonArray.length()];
