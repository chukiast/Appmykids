...
public class Showvaccine6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_showvaccine6);
    ...
    public class SynJSON extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... voids) {
            try {
                String strURL = "http://10.0.2.2/webmykids/php_get_reportvac4_6.php";
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                final String[] DTP5 = new String[jsonArray.length()];
                final String[] OPV5 = new String[jsonArray.length()];
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    DTP5[i] = jsonObject.getString("DTP5");
                    OPV5[i] = jsonObject.getString("OPV5");
                    ...
                    txt1.setText("สถานะ : " + " " + DTP5[i]);


                    txt3 = (TextView) findViewById(R.id.txt3);
                    txt3.setText("สถานะ : " + " " + OPV5[i]);
