...
public class Showvaccine2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_showvaccine2);
    ...
    public class SynJSON extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... voids) {
            try {
                String strURL = "http://10.0.2.2/webmykids/php_get_reportvac2.php";
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                final String[] JE3 = new String[jsonArray.length()];
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    JE3[i] = jsonObject.getString("JE3");
