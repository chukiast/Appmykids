...
public class Showvaccine9m_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_showvaccine9m_1);
    ...
    public class SynJSON extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... voids) {
            try {
                String strURL = "http://10.0.2.2/webmykids/php_get_reportvac9m.php";
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                final String[] JE1 = new String[jsonArray.length()];
                final String[] MEASLES = new String[jsonArray.length()];
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    if(jsonObject.getString("username").equals(strusername)){
                        ...
                        JE1[i] = jsonObject.getString("JE1");
                        MEASLES[i] = jsonObject.getString("MEASLES");
                    ...
                    txt1.setText("สถานะ : " + " " + JE1[i]);


                    txt3 = (TextView) findViewById(R.id.txt3);
                    txt3.setText("สถานะ : " + " " + MEASLES[i]);
